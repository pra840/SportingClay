...
//            EncDec encrypter = new EncDec("");
//
//            // Pass the word to be Encrypted to Encrypt()
//            System.out.println( "encrypt the String: s9ej3oq0");
//            String encrypted = encrypter.encrypt("s9ej3oq0");
//            System.out.println( "encrypted String:"+ encrypted);
//
//            // Pass the encrypted word to be Decrypted to Decrypt()
//            String decrypted = encrypter.decrypt("CiBGh1o+NpI5XipRnT6It62BRTqTT6/ywoc3WdRMi0qa8hKPAQEBAgB4RodaPjaSOV4qUZ0+iLetgUU6k0+v8sKHN1nUTItKmvIAAABmMGQGCSqGSIb3DQEHBqBXMFUCAQAwUAYJKoZIhvcNAQcBMB4GCWCGSAFlAwQBLjARBAxRxTgq9sGF+VRQdM4CARCAI2e4OaxLahZofVXe9kqFNVWVejWYLOG/l0cz/2fpjuiimKO8");
